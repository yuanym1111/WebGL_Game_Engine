...
SkinnedAnimation.prototype.loadAnimation = function (url,callback) {
...
SkinnedAnimation.prototype._parseAnim = function (anim) {
        ...
        for (i in this.keyframes) {
            ...
            for(j in keyframe) {
                ...
                //4 quat parameter (w,x,y,z)
                bone.rot = Vector.create(bone.rot);
                */
                
                /*  Use gl-matrix lib to debug purpose  */
...
SkinnedAnimation.prototype.evaluate = function (frameId, model) {
...
/*
                ...
                bone.worldPos = quat4MultiplyVecor(parent.worldRot,bone.pos);
                //    vec3.add(bone.worldPos, parent.worldPos);
                bone.worldPos = bone.worldPos.add(parent.worldPos);
                //quat4.multiply(parent.worldRot, bone.rot, bone.worldRot);
                bone.worldRot = quat4MultiplyQuat4(parent.worldRot, bone.rot);
*/
            ...
            if(bone.skinned) {
            	/*
                bone.boneMat = fromRotationTranslation(bone.worldRot, bone.worldPos);
                bone.boneMat = bone.boneMat.multiply(bone.bindPoseMat);
                */
